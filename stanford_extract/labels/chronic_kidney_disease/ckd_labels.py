...
class ckd_labels(labels_base):
    ...
    def positive_diagnoses(self, merged):
        ...
        all_ckd = pd.concat([all_ckd, merged.loc[merged['ICD10 Code'].str.contains('^I12', na=False)]])
        all_ckd = pd.concat([all_ckd, merged.loc[merged['ICD10 Code'].str.contains('^I13', na=False)]])
